...
const data = { title: 'Beans on toast', level: 'Easy Peasy', ingredients: 'Beans, toast, cheese', cuisine: 'English', dishType: 'main_course', duration: 15, creator: 'Jess' };
...
Recipe.insertMany(array, (error, recipe) => {
  if (error) {
    console.log('An error happened:', error);
    return;
   }
   console.log('The recipes are saved: ', recipe);
});
